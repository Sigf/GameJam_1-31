...
public class player : MonoBehaviour {
	...
	public void castAbility(){
		if(equiped_ability != null)equiped_ability.Cast(transform.position + (transform.GetChild(0).transform.GetChild(0).transform.up * (transform.GetComponent<BoxCollider2D>().size.y/2)));
